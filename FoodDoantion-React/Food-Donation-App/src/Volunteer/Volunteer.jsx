          ...
          <div>
            <nav class="navbar">
              <ul>
                ...
                <li><a href="#" id="dashboard" onClick={() => {showContent('dashboard');}} style={getButtonStyle('dashboard')}>Dashboard</a></li>
                <li><a href="#" id="profile" onClick={() => {showContent('instruction');}} style={getButtonStyle('instruction')}>Instructions</a></li>
              </ul>
            </nav>
